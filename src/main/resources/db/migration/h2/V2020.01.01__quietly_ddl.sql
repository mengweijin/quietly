...
create TABLE QTL_API_DEFINITION (
  ...
  request_media_type varchar(100) NULL COMMENT '请求media类型. For example: "application/json;charset=UTF-8". Refer to ${@link class org.springframework.http.MediaType}',
