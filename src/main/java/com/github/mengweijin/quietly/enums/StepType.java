...
public enum StepType implements IEnum<String> {
     ...
     * 行为：发送一个 http 请求
     */
    ACTION_SEND_HTTP_REQUEST("动作-调用接口，发送HTTP请求"),
