  ...
  <el-container>
    <el-aside :width="isCollapse ? '64px' : '200px'">
      ...
      <el-menu router mode="vertical" :collapse="isCollapse" :collapse-transition="false" unique-opened :default-active="activeMenu" @select="onSelectMenu">
        ...
        <el-menu-item index="/quietly/datasource">              <el-icon><Tickets /></el-icon><template #title>API 自动化测试用例</template></el-menu-item>
        <el-menu-item index="/quietly/datasource">              <el-icon><Tickets /></el-icon><template #title>E2E 自动化测试用例</template></el-menu-item>
        <el-menu-item index="/quietly/datasource" disabled>     <el-icon><Tickets /></el-icon><template #title>UI 自动化测试用例</template></el-menu-item>
        <el-menu-item index="/quietly/datasource" disabled>     <el-icon><Tickets /></el-icon><template #title>手工测试用例</template></el-menu-item>
        <!-- <el-sub-menu index="/">
